...
import { deleteDenda } from "@/lib/wrapper-actions";
import { Denda } from "@prisma/client";
import Link from "next/link";
import { useState } from "react";

const ActionCellDenda = ({ data }: { data: Denda }) => {
  ...
  return (
    <DropdownMenu open={open} onOpenChange={() => setOpen(!open)}>
      ...
      <DropdownMenuContent align="end">
        ...
        <Link href={`/denda/edit/${data.id}`} className="">
...
export default ActionCellDenda;
