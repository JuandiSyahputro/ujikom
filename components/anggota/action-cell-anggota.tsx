...
import { deleteAnggota } from "@/lib/wrapper-actions";
import Link from "next/link";
import { useState } from "react";

const ActionCellAnggota = ({ data }: { data: Anggota }) => {
  ...
  return (
    <DropdownMenu open={open} onOpenChange={() => setOpen(!open)}>
      ...
      <DropdownMenuContent align="end">
        ...
        <Link href={`/anggota/edit/${data.id}`} className="">
...
export default ActionCellAnggota;
